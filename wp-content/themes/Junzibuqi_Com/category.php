...
$pagedtext = '';
if( $paged && $paged > 1 ){
	$pagedtext = ' <small>第'.$paged.'頁</small>';
}
...
<div class="pageheader">
	<div class="container">
		<div class="share bdsharebuttonbox">
	  	...
	  	<div class="note"><?php echo $description ? $description : '去分類設置中添加分類描述吧' ?></div>
	</div>
</div>
<?php } ?>
					...
					while ( have_posts() ) : the_post(); 
					    echo '<article class="excerpt-minic">';
					        ...
					        if ( comments_open() && $p_meta && $p_meta['view'] ) {
					            echo '<a class="pc" href="'.get_comments_link().'"><i class="fa fa-comments-o"></i>評論('.get_comments_number('0', '1', '%').')</a>';
					        }
