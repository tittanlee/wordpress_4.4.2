...
function _postmeta_from_create() {
    ...
    if ( function_exists('add_meta_box') ) {
        add_meta_box( 'new-meta-boxes', __('來源', 'haoui'), '_postmeta_from', 'post', 'normal', 'high' );
    }
}
...
function _postmeta_keywords_description_create() {
    global $theme_name;
    if ( function_exists('add_meta_box') ) {
        add_meta_box( 'postmeta_keywords_description_boxes', __('自定義關鍵字和描述', 'haoui'), '_postmeta_keywords_description', 'post', 'normal', 'high' );
    }
}
...
function _postmeta_link_create() {
    global $theme_name;
    if ( function_exists('add_meta_box') ) {
        add_meta_box( 'postmeta_link_boxes', __('直達鏈接', 'haoui'), '_postmeta_link', 'post', 'normal', 'high' );
    }
}
