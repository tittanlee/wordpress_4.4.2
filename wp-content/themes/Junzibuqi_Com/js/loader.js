...
$(document).on("click", ".paizhuan",
function() {
    $(this).postcai();
});

if( $('.paizhuan').length ){
    $('.paizhuan').on('click', function(){
        var _this = $(this)
        if( !$('#paizhuan').length ){
            $('body').append('\
                <div class="modal fade" id="paizhuan" tabindex="-1" role="dialog" aria-hidden="true">\
                    <div class="modal-dialog" style="margin-top:200px;width:340px;">\
                        <div class="modal-content">\
                            ...
                            <div class="modal-body" style="text-align:center">\
                                <img style="max-width:100%" src="http://www.junzibuqi.com/wp-content/uploads/2015/06/logo1.png">\
                            </div>\
                        </div>\
                    </div>\
                </div>\
...
if( $('.dengxiang').length ){
	...
	return function (url, ready, load, error) {
		...
		imgReady(''+ _this.data('scr') +'', function () {
			 if(this.width >=_w){
					this.width = _w;
             }
        if( !$('#dengxiang').length ){
            $('body').append('\
                <div class="modal fade" id="dengxiang" tabindex="-1" role="dialog" aria-hidden="true">\
                    <div class="modal-dialog" style="margin-top:200px;width:' + this.width + 'px;">\
                        <div class="modal-content">\
                            <div class="modal-header">\
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>\
                                <h4 class="modal-title">'+ _this.attr('title') +'</h4>\
                            ...
                            <div class="modal-body" style="text-align:center">\
                                <img style="max-width:100%" src="'+ _this.data('scr') +'">\
                            </div>\
                        </div>\
                    </div>\
                </div>\
