 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'B.&x04`Et+fwA]$G DH]DEf7[!+(ZI|HmS bvd}]yLFiKG)(-JyV95r#(jz}8g&H');
define('SECURE_AUTH_KEY',  'lK}o@f_KN`CachMb#]dk##4RgA]Kne5fX;27Kj@hV3$!aXZ/U;_-$7@+e5oqz8EI');
define('LOGGED_IN_KEY',    'Ad,Amb>4imit|=+oLavQq(i3rIP( 3#3~ GZ|Yu|vQULzUIYz,IN&yx xb9c,,lg');
define('NONCE_KEY',        'mL;Y(0}Rst>:jH~wU.~1h!7g*|M1dn6n-NZu2r?H;[V+G.XSwR0<]B*BAWT_7a1F');
define('AUTH_SALT',        '4N0BA(vEw>~dq4TSgdr6#Q_],u:h3|g#,LDQ`ja]|q6Bn5RMRUuT|fIO~#ci4MRw');
define('SECURE_AUTH_SALT', 'j G$R7o3r5<zX6{+.&+FNaj!qnKP>G.k TA_oP/%9+{5s+.2n3B>R|[c2| 26Eq|');
define('LOGGED_IN_SALT',   'PCUc93m/5[r-A#fteTZe[0Kc^~91:y.SJC4|p|11/2m[{9Qb-vgP9H#3(tZ3}AwY');
define('NONCE_SALT',       'Sb%%w@J@z+C4k!U?S<GZ%#=i3C?tq,d6Y2Ssem]_^8R4,D66hV%NGW+)a;b[)Z:-');
