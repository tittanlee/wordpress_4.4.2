...
return {
	init: function (){
		var 
			...
			_msg = {
				// 1-2位：類型；3-4位：01-69指客戶端操作提示，71-99指服務端操作提示
				1101: '該欄目下暫無數據！',
				1079: '服務器異常，請稍候再試！',
		...
		*/
		...
		function loading(el, msg){
			if( !msg ){
				msg = '<i class="fa fa-spinner fa-spin" style="position:relative;top:1px;margin-right:5px;"></i> 數據加載中'
			}
