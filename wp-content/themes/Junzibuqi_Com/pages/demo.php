...
<head>
<meta charset="UTF-8" />
<title>網站演示：<?php echo get_the_title($pid); ?> - 君子不器</title>
<style type="text/css">
...
<body>
   <div id="header-bar">
     <div class="close-header">
       <script type="text/javascript">document.write("<a id=\"close-button\" title=\"關閉工具條\" class=\"close\" href=\"<?php echo $theCode; ?>/\">X</a>");</script>
     </div>
     <p class="meta-data">
       <script type="text/javascript">document.write("<a target=\"_blank\" class=\"close\" href=\"<?php echo $theCode; ?>\">移除頂部</a>");</script> <a class="back" href="<?php echo get_permalink($pid); ?>">&laquo; 返回原文：<?php echo get_the_title($pid); ?></a>&laquo; <a class="back" href="http://junzibuqi.com/">返回君子不器（Junzibuqi.Com）首頁</a>
