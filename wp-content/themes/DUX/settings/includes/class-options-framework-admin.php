...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => __( 'DUX 主題設置', 'haoui' ),
			'menu_title' => __( 'DUX 主題設置', 'haoui' ),
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit">
					<input type="submit" class="button-primary" name="update" value="<?php echo __( '保存設置', 'haoui' ); ?>" />
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php echo __( '重置全部設置', 'haoui' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'textdomain' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
			<div class="opshui-sidebar"><div class="opshui-sidebar-widget"><a href="http://themebetter.com" target="_blank"><img src="http://themebetter.com/R4AMjmodyAOnOB52/tui"></a></div></div>
		</div>
	...
	function validate_options( $input ) {
		...
		if ( isset( $_POST['reset'] ) ) {
			add_settings_error( 'options-framework', 'restore_defaults', __( '設置已重置！', 'haoui' ), 'updated fade' );
	...
	function save_options_notice() {
		add_settings_error( 'options-framework', 'save_options', __( '設置保存成功！', 'haoui' ), 'updated fade' );
	}
